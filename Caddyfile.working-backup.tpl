...
:8080 {
    ...
    # Handle WebSocket paths with minimal WAF protection
    handle /ws/* {
        coraza_waf {
            directives `
                # Basic security for WebSockets
                SecAction "id:100,phase:1,pass,nolog,initcol:tx=tx"
                SecAction "id:101,phase:1,pass,nolog,setvar:tx.ws_rate=0"
                
                # WebSocket rate limiting
                SecRule REQUEST_HEADERS:Upgrade "@streq websocket" "id:102,phase:1,pass,msg:'WebSocket connection',setvar:tx.ws_rate=+1,expirevar:tx.ws_rate=60"
                SecRule TX:ws_rate "@gt 10" "id:103,phase:1,deny,status:429,msg:'WebSocket rate limit exceeded'"
                
                # Block suspicious patterns in WebSocket requests
                SecRule REQUEST_URI "@detectSQLi" "id:104,phase:1,deny,status:403,msg:'SQL injection attempt in WebSocket path'"
                SecRule REQUEST_URI "@detectXSS" "id:105,phase:1,deny,status:403,msg:'XSS attempt in WebSocket path'"
            `
        }
