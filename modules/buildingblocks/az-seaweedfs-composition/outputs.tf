...
| Domain | Target IP |
|--------|-----------|
| `${meshstack_building_block_v2.namespace.status.outputs.s3_api_url.value_string}` | `${var.worker_node_ip}` |
| `${meshstack_building_block_v2.namespace.status.outputs.keycloak_url.value_string}` | `${var.worker_node_ip}` |
