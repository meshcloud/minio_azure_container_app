  ...
  data = {
    "oidc.json" = jsonencode({
      ...
      providers = [{
        ...
        enabled = true
        config = {
          issuer      = "https://${local.keycloak_fqdn}/realms/seaweedfs"
      ...
      roles = [
        {
          ...
          trustPolicy = {
            ...
            Statement = [{
              ...
              Condition = {
                StringEquals = {
                  "oidc:iss"   = "https://${local.keycloak_fqdn}/realms/seaweedfs"
      ...
      spec {
        ...
        dynamic "host_aliases" {
          ...
          content {
            ...
            hostnames = [local.keycloak_fqdn, local.seaweedfs_fqdn]
          }
        }
